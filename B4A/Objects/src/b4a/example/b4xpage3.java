...
public class b4xpage3 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.b4xpage3");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.b4xpage3.class).invoke(this, new Object[] {null});
        else
...
_root = _root1;
 //BA.debugLineNum = 16;BA.debugLine="Root.LoadLayout(\"Page3\")";
_root.LoadLayout("Page3",ba);
 //BA.debugLineNum = 17;BA.debugLine="B4XPages.SetTitle(Me, \"畫面3\")";
_b4xpages._settitle /*String*/ (ba,this,(Object)("畫面3"));
