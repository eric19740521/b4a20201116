...
public static boolean _usehomeclickfordrawer = false;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Public UseHomeClickForDrawer As Boolean = False";
_usehomeclickfordrawer = anywheresoftware.b4a.keywords.Common.False;
