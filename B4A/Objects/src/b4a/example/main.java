...
public b4a.example.b4xpagesmanager _pm = null;
...
public static String  _activity_actionbarhomeclick() throws Exception{
 ...
 //BA.debugLineNum = 34;BA.debugLine="Log(\"ActionBarHomeClick \" & pm.GetTopPage.Id)";
anywheresoftware.b4a.keywords.Common.LogImpl("5196609","ActionBarHomeClick "+mostCurrent._pm._gettoppage /*b4a.example.b4xpagesmanager._b4xpageinfo*/ ().Id /*String*/ ,0);
 //BA.debugLineNum = 35;BA.debugLine="If pm.GetTopPage.Id = \"page2\" Then";
if ((mostCurrent._pm._gettoppage /*b4a.example.b4xpagesmanager._b4xpageinfo*/ ().Id /*String*/ ).equals("page2")) { 
 //BA.debugLineNum = 36;BA.debugLine="Starter.UseHomeClickForDrawer = True";
mostCurrent._starter._usehomeclickfordrawer /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 };
...
mostCurrent._pm._initialize /*String*/ (mostCurrent.activityBA,mostCurrent._activity);
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 47;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 48;BA.debugLine="Return B4XPages.Delegate.Activity_KeyPress(KeyCod";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="B4XPages.Delegate.Activity_Pause";
mostCurrent._b4xpages._delegate /*b4a.example.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
 //BA.debugLineNum = 57;BA.debugLine="End Sub";
return "";
}
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
 //BA.debugLineNum = 60;BA.debugLine="B4XPages.Delegate.Activity_PermissionResult(Permi";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 52;BA.debugLine="B4XPages.Delegate.Activity_Resume";
...
public static String  _create_menu(Object _menu) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub Create_Menu (Menu As Object)";
 //BA.debugLineNum = 64;BA.debugLine="B4XPages.Delegate.Create_Menu(Menu)";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Dim pm As B4XPagesManager";
mostCurrent._pm = new b4a.example.b4xpagesmanager();
